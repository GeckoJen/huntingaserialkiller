...
function Part1Hints({storyPartReachedPart1, recordHints}) {
  
    console.log("test")
    console.log(storyPartReachedPart1);
  
    return (
      <div>
        {storyPartReachedPart1.newcase && (
          <div className="hintSection">
            <div className="hintsHeader">
              ...
              <p>
                Look at the blood splatters on the police caution tape. Can you
                see some that are different from the others?
                </p>
        ...
        {storyPartReachedPart1.atthecrimescene && (
          <div className="hintSection">
            <div className="hintsHeader">
              <h3>
            ...
            <p>
              Pay attention to the shapes on the top of the box, and the shapes
              on the code panel.
            </p>
            ...
            <p>
              ...
              digit, match up the white circle from the front of the box with
              the circle containing number I on top of the box. The first digit
              of the code is in the square box above the white dot - so a number
              1.
            </p>
            <button disabled={false} onClick={(e) => recordHints(e.target)}>
              Answer
        ...
        {storyPartReachedPart1.insidethebox && (
          <div className="hintSection">
            <div className="hintsHeader">
              <h3>
            ...
            <p>
              ...
              of a word) reads:<br></br>"The next murder will be at 37 Ark
              Street" <br></br>
        ...
        {storyPartReachedPart1.thenextcrimescene && (
          <div className="hintSection">
            <div className="hintsHeader">
              <h3>
        ...
        {storyPartReachedPart1.insidethehouse && (
          <div className="hintSection">
            <div className="hintsHeader">
              <h3>
        ...
        {storyPartReachedPart1.thenextbody && (
          <div className="hintSection">
            <div className="hintsHeader">
              <h3>
            ...
            <p>
              You need to rearrange the letters in the note for it to make
              sense. Look at the numbers for a clue as to how to do it.
            </p>
            ...
            <p>
              ...
              then column 2 etc. Then, move the rows so that row 1 is first,
              then row 2 etc. Now you should just be able to read across each
              line to find the message.
            </p>
            <button disabled={false} onClick={(e) => recordHints(e.target)}>
              Answer
            </button>
        ...
        {storyPartReachedPart1.goinghome && (
          <div className="hintSection">
            <div className="hintsHeader">
              <h3>
            ...
            <p>
              The key to solving this riddle is the phrase "I'm oddly beginning
              to like you."
            </p>
            ...
            <p>
              If you take the beginning letter of each odd word in the riddle,
              and put them together, what do you come up with?
            </p>
            <button disabled={false} onClick={(e) => recordHints(e.target)}>
              Answer
            </button>
        ...
        {storyPartReachedPart1.thecodekiller && (
          <div className="hintSection">
            <div className="hintsHeader">
              <h3>
            ...
            <p>
              Solve the four hints written on the wall. Use Google if you need
              to. What do you notice about the answers?
            </p>
            ...
            <p>
              ...
              up, down, left and right from a central point, can you work out
              how that might relate to a code on the keypad?
            </p>
            <button disabled={false} onClick={(e) => recordHints(e.target)}>
              Answer
            </button>
